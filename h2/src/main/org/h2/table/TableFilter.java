...
public class TableFilter implements ColumnResolver {
    ...
    private TableFilter tableFilterlinshi;
    ...
    private ArrayList<Index> listIndex;

    public ArrayList<Index> getListIndex() {
        return listIndex;
    }

    public void setListIndex(ArrayList<Index> listIndex) {
    ...
    public TableFilter getTableFilterlinshi() {
        return tableFilterlinshi;
    }

    public void setTableFilterlinshi(TableFilter tableFilterlinshi) {
        this.tableFilterlinshi = tableFilterlinshi;
    }
