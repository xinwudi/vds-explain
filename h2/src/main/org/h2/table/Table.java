...
public abstract class Table extends SchemaObjectBase {
    ...
    //改动！！！！！
    public void addTableFilters(List<TableFilter> tablefilters) {
        if (tablefilters.contains(this)) {
            return;
        }
        ...
        if (this instanceof TableView) {
            if (((TableView) this).getViewQuery() instanceof Select) {
                tablefilters.add(((Select) ((TableView) this).getViewQuery()).getTopTableFilter());
            }
        }
